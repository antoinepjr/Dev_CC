...
?>
<title>Spotify Curators</title>
</head>
<header>
	<div class="topnav a">
		<a href="Platform.php">PLATFORMS</a>
		<a class = "active" href="S_Curators.php">SPOTIFY</a>
...
<body>
	<div class="container">
		<?php
			...
			foreach($cursor as $document){
				...
				$count_spotify = $document->platform[0]->spotify[0]->playlist;
				$playlistCount = count($count_spotify);
				$name = $document->name;
	...
	<script>
		function goToPlaylistList(name){
			window.location = "PlaylistList.php?name="+name+"&platform=spotify";
